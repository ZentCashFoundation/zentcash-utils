...
/**
 * Module of Zent Cash Cryptographic Methods
 * @module Crypto
 * @class
 */
class Crypto {
...
function loadBrowserWASM () {
  ...
  try {
    const Self = window.ZentCashCrypto()
...
function loadNativeAddon () {
  try {
    const Self = require('zentcash-crypto')
...
function loadNativeJS () {
  try {
    const Self = require('./zentcash-crypto.js')()
...
function loadWASMJS () {
  ...
  try {
    const Self = require('./zentcash-crypto-wasm.js')()
