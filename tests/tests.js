// Copyright (c) 2018-2023, The Zent ash Developers
//
...
const ZentCashCrypto = new Crypto()
const ZentCashUtils = require('../').CryptoNote
const cnUtil = new ZentCashUtils(require('../config.json'))

console.log('Using Crypto: %s', ZentCashCrypto.type)

describe('Cryptography', function () {
  this.timeout(10000)

  it('Generate Random Keys', () => {
    const [err, keys] = ZentCashCrypto.generateKeys()
  ...
  it('Check Key - Public Key', () => {
    ...
    const isValid = ZentCashCrypto.checkKey(key)
  ...
  it('Tree Hash', () => {
    ...
    const [err, treeHash] = ZentCashCrypto.tree_hash([
  ...
  it('Tree Branch', () => {
    ...
    const [err, treeBranch] = ZentCashCrypto.tree_branch([
      'b542df5b6e7f5f05275c98e7345884e2ac726aeeb07e03e44e0389eb86cd05f0',
      '1b606a3f4a07d6489a1bcd07697bd16696b61c8ae982f61a90160f4e52828a7f',
      'c9fae8425d8688dc236bcdbc42fdb42d376c6ec190501aa84b04a4b4cf1ee122',
      '871fcd6823f6a879bb3f33951c8e8e891d4043880b02dfa1bb3be498b50e7578'
  ...
  algos.forEach((algo) => {
    it(algo.name, () => {
      const [err, hash] = ZentCashCrypto[algo.func](testdata)
...
describe('Transactions', function () {
  ...
  describe('Create Transaction Outputs', () => {
    it('Amount: 1234567', () => {
      ...
      const transfers = cnUtil.createTransactionOutputs('Ze527LxFXCdVcFVhtx95KxYCL7exsHrDuSwRzzDQziGqB8uiEMEKidNY57oRvR1Ge23qoDeVjzsRYV5q28MYJ98e1KDFCapCP', amount)
  ...
  describe('Creation', () => {
    it('generate a transaction', () => {
      const madeOutputs = cnUtil.createTransactionOutputs('Ze527LxFXCdVcFVhtx95KxYCL7exsHrDuSwRzzDQziGqB8uiEMEKidNY57oRvR1Ge23qoDeVjzsRYV5q28MYJ98e1KDFCapCP', 90)
      const txPublicKey = '3b0cc2b066812e6b9fcc42a797dc3c723a7344b604fd4be0b22e06254ff57f94'
      const walletPrivateViewKey = '6968a0b8f744ec4b8cea5ec124a1b4bd1626a2e6f31e999f8adbab52c4dfa909'
      const walletPrivateSpendKey = 'd9d555a892a85f64916cae1a168bd3f7f400b6471c7b12b438b599601298210b'
      const walletPublicSpendKey = '854a637b2863af9e8e8216eb2382f3d16616b3ac3e53d0976fbd6f8da6c56418'
    ...
    it('generate a fusion transaction', () => {
      const madeOutputs = cnUtil.createTransactionOutputs('Ze527LxFXCdVcFVhtx95KxYCL7exsHrDuSwRzzDQziGqB8uiEMEKidNY57oRvR1Ge23qoDeVjzsRYV5q28MYJ98e1KDFCapCP', 13080)
      const txPublicKey = '3b0cc2b066812e6b9fcc42a797dc3c723a7344b604fd4be0b22e06254ff57f94'
      const walletPrivateViewKey = '6968a0b8f744ec4b8cea5ec124a1b4bd1626a2e6f31e999f8adbab52c4dfa909'
      const walletPrivateSpendKey = 'd9d555a892a85f64916cae1a168bd3f7f400b6471c7b12b438b599601298210b'
      const walletPublicSpendKey = '854a637b2863af9e8e8216eb2382f3d16616b3ac3e53d0976fbd6f8da6c56418'
    ...
    it('fail to generate a fusion transaction when not enough outputs are created', () => {
      const madeOutputs = cnUtil.createTransactionOutputs('Ze527LxFXCdVcFVhtx95KxYCL7exsHrDuSwRzzDQziGqB8uiEMEKidNY57oRvR1Ge23qoDeVjzsRYV5q28MYJ98e1KDFCapCP', 12000)
      const txPublicKey = '3b0cc2b066812e6b9fcc42a797dc3c723a7344b604fd4be0b22e06254ff57f94'
      const walletPrivateViewKey = '6968a0b8f744ec4b8cea5ec124a1b4bd1626a2e6f31e999f8adbab52c4dfa909'
      const walletPrivateSpendKey = 'd9d555a892a85f64916cae1a168bd3f7f400b6471c7b12b438b599601298210b'
      const walletPublicSpendKey = '854a637b2863af9e8e8216eb2382f3d16616b3ac3e53d0976fbd6f8da6c56418'
    ...
    it('fail to generate a transaction with an excessive number of outputs', () => {
      ...
      for (var i = 0; i < 100; i++) {
        cnUtil.createTransactionOutputs('Ze527LxFXCdVcFVhtx95KxYCL7exsHrDuSwRzzDQziGqB8uiEMEKidNY57oRvR1Ge23qoDeVjzsRYV5q28MYJ98e1KDFCapCP', 90).forEach(out => madeOutputs.push(out))
      }
